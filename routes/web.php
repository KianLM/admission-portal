...
Route::prefix('applicant')->middleware(['auth'])->group(function(){
    ...
    //Route::get('/application-form/show', [App\Http\Controllers\ApplicationShowController::class,'showApplicationForm']);
    //Route::post('/dataInput', [ApplicationFormController::class, 'dataInput']);
...
Route::prefix('admission')->middleware(['auth', 'isAdmission'])->group(function(){
    ...
    Route::get('/all-admissions', [App\Http\Controllers\ApplicationShowController::class, 'showApplicationForm']);
